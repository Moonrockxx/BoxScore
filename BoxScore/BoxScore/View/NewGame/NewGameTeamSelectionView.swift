...
struct NewGameTeamSelectionView: View {
    ...
    let teams: [Team] = [Team(categorie: .u11, players: [], games: [], score: 0, isMenTeam: true, isMultipleTeams: false),
                         ...
                         Team(categorie: .s ,players: [Player(firstName: "Kobe", lastName: "Bryant", number: "8", points: 0, rebonds: 0, assists: 0, turnovers: 0, interceptions: 0, blocks: 0, freeThrowMade: 0, twoPointMade: 0, threePointMade: 0),
                                                       ...
                                                       Player(firstName: "Thomas", lastName: "Ferré", number: "5", points: 0, rebonds: 0, assists: 0, turnovers: 0, interceptions: 0, blocks: 0, freeThrowMade: 0, twoPointMade: 0, threePointMade: 0)], games: [], score: 0,
                              isMenTeam: true,
